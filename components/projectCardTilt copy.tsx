  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        initial={{ opacity: 0 }}
        animate={{
          opacity: [0, 0.7, 0.85, 1],
          scale: isOpen ? 2 : 1,
          zIndex: isOpen ? 50 : 30,
        }}
        exit={{ opacity: [1, 0.85, 0.7, 0] }}
        transition={{
          duration: 0.6,
          ease: "easeIn",
      ...
      >
        <motion.div
          ...
          className={`relative  xl:max-w-auto cursor-pointer hover:-z-50 overflow-hidden rounded-lg border p-5 ${
            isOpen
              ? "xl:max-h-[90dvh]"
              : "xl:max-h-[35dvh]         dark:bg-[#0A0A0A]/10 border-pink-200/50 dark:border-[#1A1A1A]/10    dark:shadow-[0_0_20px_rgba(0,0,0,0.4)] shadow-[0_0_20px_rgba(0,0,0,0.1)]"
          } z-30 bg-gray-300/3
          ${className || ""}`}
          style={{
